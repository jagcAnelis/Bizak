...
{if isset($number_of_reviews) && $number_of_reviews > 0}
    <span itemtype="http://schema.org/Product" itemscope>
        ...
        <div class="stars-container" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
            <div style="{if $cattopmargin != 0}padding-top:{$cattopmargin|intval}px;{/if}{if $catbotmargin != 0}padding-bottom:{$catbotmargin|intval}px;{/if} display:table; margin: 2px 5px 5px 5px">
