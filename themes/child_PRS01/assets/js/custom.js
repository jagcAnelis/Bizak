...
$( "#content #ttcmsbanner,#content #ttcmstestimonial" ).wrapAll( "<div class='container col-sm-12 tttestimonial-banner clearfix'><div class='row'></div></div>" );
	...
	/* -----------Start carousel For TT- brand logo ----------- */
	var ttcategorylogo = $("#ttcategorylogo-carousel");
	ttcategorylogo.owlCarousel({
		navigation:true,
		navigationText: [
			"<i class='material-icons'>&#xE5CB;</i>",
			"<i class='material-icons'>&#xE5CC;</i>"],
...
function display(view)
{
	if (view == 'list')
	{
		...
		$('#content-wrapper .products.product-thumbs .product-miniature').attr('class', 'product-miniature js-product-miniature product-list col-xs6');
...
$(window).on('load', function() {
	$('.crosssell_product_list_wrapper.layout-slide').slick("refresh");
});
...
$(window).on('load', function() {
	if ($('body').hasClass('page-category')) {
		...
		var notSorted = url.indexOf("?") === -1 ;
		if (notSorted && urlItems[urlItems.length - 1 ] !== 'brands') {
			$('<a class="js-search-link default-sort-by-custom" href="'+ window.location.href + '?order=product.sales.desc' +'">' +'</a>').appendTo($('body'));
			$('.default-sort-by-custom').click();
		}
