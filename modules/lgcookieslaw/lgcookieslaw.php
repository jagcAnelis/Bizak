    ...
    public function getContent()
    {
        ...
        $this->fields_form[0]['form']['input'] = array(
            array(
                ...
                'desc' =>
                    $this->l(
                        'Don´t forget to disable the preview mode once you have finished configuring the banner.'
                    ),
                'type' => 'free',
                'name' => 'important',
            ),
            ...
            array(
                ...
                'desc' =>
                    $this->l(
                        'With this option your banner styles set initially as disabled:none then show by javascript. '
                    ).
