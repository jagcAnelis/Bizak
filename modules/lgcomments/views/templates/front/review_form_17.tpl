                        ...
                        <table class="std table">
                            <tr class="item">
                                <td class="item" colspan="2">
                                    ...
                                    <textarea maxlength="255" id="lg_nick" name="lg_nick" style="width:100%;height:25px;" required></textarea>
                                    ...
                                    <tr>
                                        ...
                                        <td class="history_link bold">{l s='Title:' mod='lgcomments'}
                                            ...
                                            <textarea maxlength="50" style="width:100%;height:25px;"
                                                      name="product_title_{$product.id_order_detail|escape:'htmlall':'UTF-8'}_{$product.product_id|escape:'htmlall':'UTF-8'}" required>{if !empty($data[$index])}{$data[$index]|escape:'htmlall':'UTF-8'}{/if}</textarea>
                                            ...
                                            <textarea name="product_comment_{$product.id_order_detail|escape:'htmlall':'UTF-8'}_{$product.product_id|escape:'htmlall':'UTF-8'}"
                                                      style="width:100%;height:60px;" required>{if !empty($data[$index])}{$data[$index]|escape:'htmlall':'UTF-8'}{/if}</textarea>
                        ...
                        <fieldset>
                            ...
                            <table class="std table">
                                ...
                                <tr>
                                    ...
                                    <td class="history_link bold">{l s='Title:' mod='lgcomments'}
                                        <textarea maxlength="50" name="title_store" style="width:100%;height:25px;" required>{if !empty($data['title_store'])}{$data['title_store']|escape:'htmlall':'UTF-8'}{/if}</textarea>
                                        {if isset($errors_store['title'])}
                                            <div class="alert alert-danger">{$errors_store['title']|escape:'htmlall':'UTF-8'}</div>
                                        {/if}
                                        <br>{l s='Comment:' mod='lgcomments'}
                                        <textarea name="comment_store" style="width:100%;height:60px;" required>{if !empty($data['comment_store'])}{$data['comment_store']|escape:'htmlall':'UTF-8'}{/if}</textarea>
                                        {if isset($errors_store['comment'])}
                                            <div class="alert alert-danger">{$errors_store['comment']|escape:'htmlall':'UTF-8'}</div>
                                        {/if}
                                    </td>
                                </tr>
