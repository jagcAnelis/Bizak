...
<section id="main">
    <header class="page-header">
        <h1 class="h1">{l s='Customer reviews' mod='lgcomments'}</h1>
    </header>
        ...
        <section id="lgcomments_products" class="lgcomments_store_reviews">
                                    ...
                                    <td>
                                        <p class="small">
                                            <a href="{$star_link|escape:'htmlall':'UTF-8'}?star=five" {if $stars.fivestars == 0}style="pointer-events: none;"{/if}>
                                                <img src="{$modules_dir|escape:'htmlall':'UTF-8'}/views/img/stars/{$starstyle|escape:'htmlall':'UTF-8'}/{$starcolor|escape:'htmlall':'UTF-8'}/10stars.png" width="100">
                                    ...
                                    <td>
                                        <p class="small">
                                            <a href="{$star_link|escape:'htmlall':'UTF-8'}?star=four" {if $stars.fourstars == 0}style="pointer-events: none;"{/if}>
                                                <img src="{$modules_dir|escape:'htmlall':'UTF-8'}/views/img/stars/{$starstyle|escape:'htmlall':'UTF-8'}/{$starcolor|escape:'htmlall':'UTF-8'}/8stars.png" width="100">
                                    ...
                                    <td>
                                        <p class="small">
                                            <a href="{$star_link|escape:'htmlall':'UTF-8'}?star=three" {if $stars.threestars == 0}style="pointer-events: none;"{/if}>
                                                <img src="{$modules_dir|escape:'htmlall':'UTF-8'}/views/img/stars/{$starstyle|escape:'htmlall':'UTF-8'}/{$starcolor|escape:'htmlall':'UTF-8'}/6stars.png" width="100">
                                    ...
                                    <td>
                                        <p class="small">
                                            <a href="{$star_link|escape:'htmlall':'UTF-8'}?star=two" {if $stars.twostars == 0}style="pointer-events: none;"{/if}>
                                                <img src="{$modules_dir|escape:'htmlall':'UTF-8'}/views/img/stars/{$starstyle|escape:'htmlall':'UTF-8'}/{$starcolor|escape:'htmlall':'UTF-8'}/4stars.png" width="100">
                                    ...
                                    <td>
                                        <p class="small">
                                            <a href="{$star_link|escape:'htmlall':'UTF-8'}?star=one" {if $stars.onestar == 0}style="pointer-events: none;"{/if}>
                                                <img src="{$modules_dir|escape:'htmlall':'UTF-8'}/views/img/stars/{$starstyle|escape:'htmlall':'UTF-8'}/{$starcolor|escape:'htmlall':'UTF-8'}/2stars.png" width="100">
                                    ...
                                    <td>
                                        <p class="small">
                                            <a href="{$star_link|escape:'htmlall':'UTF-8'}?star=zero" {if $stars.zerostar == 0}style="pointer-events: none;"{/if}>
                                                <img src="{$modules_dir|escape:'htmlall':'UTF-8'}/views/img/stars/{$starstyle|escape:'htmlall':'UTF-8'}/{$starcolor|escape:'htmlall':'UTF-8'}/0stars.png" width="100">
            ...
            {else}
                <section id="content" class="page-content page-not-found">
                    <h4>{l s='Sorry for the inconvenience.' d='Shop.Theme' mod='lgcomments'}</h4>
                    <p>{l s='There are not reviews yet' d='Shop.Theme' mod='lgcomments'}</p>
                </section>
            {/if}
        </section>
    {else}
