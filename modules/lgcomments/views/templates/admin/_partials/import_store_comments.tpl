 ...
 *             shttps://www.lineagrafica.es/licenses/license_fr.pdf
 *}
<div id="upload-store" class="lgtabcontent">
    <fieldset>
        <legend>
            <a href="{$module_path|escape:'htmlall':'UTF-8'}readme/readme_{$iso_lang|escape:'htmlall':'UTF-8'}.pdf#page=14" target="_blank">
                <span class="lglarge"><i class="icon-comments-o"></i>
                    {l s='Import store reviews' mod='lgcomments'}
        ...
        <div id="csv_uploader">
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="lgoverflow">
                    <table style="width:900px;" class="table lgcenter" border="1">
                        ...
                        <tr>
                            ...
                            <td class="lgpadding">
                                <span class="toolTip">
                                    <a href="#csv_uploader">{l s='Order ID' mod='lgcomments'}</a>
                                    <span class="tooltipDesc">
                                        {l s='In the column C of your CSV file, add the ID of the order' mod='lgcomments'}
                                        {l s='for which the comment was written (you can find it' mod='lgcomments'}
                                        <a href="index.php?tab=AdminOrders&token={$tokenO|escape:'htmlall':'UTF-8'}" target="_blank" class="lgbold">
                                            {l s='on this page' mod='lgcomments'}
                                        </a>)
                                    </span>
                                </span>
                            ...
                            <td class="lgpadding">
                                <span class="toolTip">
                                    ...
                                    <span class="tooltipDesc">
                                        {l s='In the column D of your CSV file, add the rating on the shop' mod='lgcomments'}
                            ...
                            <td class="lgpadding">
                                <span class="toolTip">
                                    ...
                                    <span class="tooltipDesc">
                                        ...
                                        {l s='that has been written about the shop' mod='lgcomments'}
                                    </span>
                                </span>
                            </td>
                            <td class="lgpadding">
                            ...
                            <td class="lgpadding">
                                <span class="toolTip">
                                    <a href="#csv_uploader">{l s='Status' mod='lgcomments'}</a>
                                    <span class="tooltipDesc">
                            ...
                            <td>
                                <span class="toolTip">
                                    ...
                                    <span class="tooltipDesc">
                                        ...
                                        {l s='(compared to the other comments about the shop)' mod='lgcomments'}
                                    </span>
                                </span>
                            </td>
                            <td class="lgpadding">
                            ...
                            <td class="lgpadding">
                                <span class="toolTip">
                                    <a href="#csv_uploader">{l s='Answer' mod='lgcomments'}</a>
                                    <span class="tooltipDesc">
                    ...
                    <div class="alert alert-info">
                        - {l s='Move your mouse over the table to get more information.' mod='lgcomments'}<br>
                        - <a href="{$module_path|escape:'htmlall':'UTF-8'}csv/example_store.csv">
                ...
                <div id="lgcomments_nick_options_store_container">
                    <h3>
                        <span class="lgfloat">
                            <label>
                                <i class="icon-key"></i>
                        ...
                        <select id="LGCOMMENTS_NICK_OPTIONS_STORE" class="lgfloat fixed-width-xl" name="LGCOMMENTS_NICK_OPTIONS_STORE">
                            <option value="0">
                    ...
                    <div id="lgcomments_force_nick_store_container" style="display: none">
                        <span class="lgfloat">
                            <label>
                                <i class="icon-key"></i>
                        ...
                        <input type="text" id="LGCOMMENTS_FORCED_NICK_STORE" name="LGCOMMENTS_FORCED_NICK_STORE" class="lgfloat fixed-width-xl" />
                    </div>
                    <br>
                    <div class="lgclear"></div>
                    <br>
                ...
                <button class="button btn btn-default lgfloatright" type="submit" name="exportStoreCSV">
                    <i class="process-icon-download"></i> {l s='Export all store comments' mod='lgcomments'}
                </button>
                <label from="storeCSV"></label>
                <button class="button btn btn-default" type="submit" name="storeCSV" >
                    <i class="process-icon-import"></i> {l s='Import the store comments' mod='lgcomments'}
                </button>
            </form>
        </div>
    </fieldset>
