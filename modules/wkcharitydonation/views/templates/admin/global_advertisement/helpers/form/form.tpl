    ...
    <div class="panel">
        ...
        <div class="form-wrapper">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="wk_text_field_all wk_text_field_{$language.id_lang|escape:'html':'UTF-8'}" {if $currentLang.id_lang != $language.id_lang}style="display:none;"{/if}>
                                <textarea id="{$advertisement_description|escape:'html':'UTF-8'}" name="{$advertisement_description|escape:'html':'UTF-8'}" class="form-control wk_tinymce" >{if isset($smarty.post.$advertisement_description) && $smarty.post.$advertisement_description}{$smarty.post.$advertisement_description}{elseif isset($donationInfo.advertisement_description[$language.id_lang])}{$donationInfo.advertisement_description[$language.id_lang]}{/if}</textarea>
                            </div>
                            {/foreach}
                        </div>
                    </div>
            ...
            <div class="form-group donate_button hidden">
                ...
                <div class="col-sm-3">
                    <div class="input-group">
                        <input type="color" name="button_text_color" id="button_text_color" class="form-control mColorPickerInput mColorPicker" data-hex="true" value="{if isset($smarty.post.button_text_color)}{$smarty.post.button_text_color|escape:'html':'UTF-8'}{elseif isset($donationInfo.button_text_color) && $donationInfo.button_text_color != null}{$donationInfo.button_text_color|escape:'html':'UTF-8'}{else}#ffffff{/if}" readonly/>
                    </div>
                </div>
            </div>
            <div class="form-group donate_button hidden">
