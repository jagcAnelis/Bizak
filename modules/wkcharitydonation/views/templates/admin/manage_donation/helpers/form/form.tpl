    ...
    <div class="panel">
        ...
        <div class="form-wrapper wk-tabs-panel">
            ...
            <ul class="nav nav-tabs" id="tab-select">
                ...
                <li>
                    <a href="#wk_donation_product_images" data-toggle="tab" data-toggle="tab">
                    ...
                    <div class="form-wrapper hidden" id="advertisement_config">
                        <div class="form-group">
                            <label for="advertisement_title" class="col-sm-3 control-label required">
                                ...
                                <img class="all_lang_icon" data-lang-id="{$currentLang.id_lang|escape:'html':'UTF-8'}" src="{$ps_img_lang_dir|escape:'html':'UTF-8'}{$currentLang.id_lang}.jpg">
                            </label>
                            <div class="col-sm-7">
                                {foreach from=$languages item=language}
                        ...
                        <div class="form-group">
                            <label for="advertisement_description" class="col-sm-3 control-label required">
                                ...
                                <img class="all_lang_icon" data-lang-id="{$currentLang.id_lang|escape:'html':'UTF-8'}" src="{$ps_img_lang_dir}{$currentLang.id_lang|escape:'html':'UTF-8'}.jpg">
                            </label>
                            <div class="col-sm-7">
                                <div class="row">
                                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="color" name="adv_desc_color" id="adv_desc_color" class="form-control mColorPickerInput mColorPicker" data-hex="true" value="{if isset($smarty.post.adv_desc_color)}{$smarty.post.adv_desc_color|escape:'htmlall':'UTF-8'}{elseif isset($donationInfo.adv_desc_color) && $donationInfo.adv_desc_color != null}{$donationInfo.adv_desc_color|escape:'html':'UTF-8'}{else}#ffffff{/if}" readonly/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group donate_button hidden">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="color" name="button_text_color" id="button_text_color" class="form-control mColorPickerInput mColorPicker" data-hex="true" value="{if isset($smarty.post.button_text_color)}{$smarty.post.button_text_color|escape:'htmlall':'UTF-8'}{elseif isset($donationInfo.button_text_color) && $donationInfo.button_text_color != null}{$donationInfo.button_text_color|escape:'html':'UTF-8'}{else}#ffffff{/if}" readonly/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group donate_button hidden">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="color" name="button_border_color" id="button_border_color" class="form-control mColorPickerInput mColorPicker" data-hex="true" value="{if isset($smarty.post.button_border_color)}{$smarty.post.button_border_color|escape:'htmlall':'UTF-8'}{elseif isset($donationInfo.button_border_color) && $donationInfo.button_border_color != null}{$donationInfo.button_border_color|escape:'html':'UTF-8'}{else}#ffffff{/if}" readonly/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <div class="panel-footer">
            ...
            <button type="submit" name="submitAdd{$table|escape:'html':'UTF-8'}AndStay" onclick=test() class="btn btn-default pull-right">
