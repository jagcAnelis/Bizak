...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'gshoppingfeed` (
    ...
    `google_product_category_rewrite` TINYINT NOT NULL DEFAULT \'0\',
    ...
    `shipping_weight_format` int(2) DEFAULT NULL,
    ...
    `export_width_inp` VARCHAR(50) NOT NULL,
    `export_height` TINYINT NOT NULL DEFAULT \'0\',
    `export_height_inp` VARCHAR(50) NOT NULL,
    `export_depth` TINYINT NOT NULL DEFAULT \'0\',
    `export_depth_inp` VARCHAR(50) NOT NULL,
