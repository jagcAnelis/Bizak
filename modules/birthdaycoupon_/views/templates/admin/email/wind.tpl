                                                                ...
                                                                <tr>          
                                                                    <td align="left" class="mlContentContainer" style="padding: 15px 50px 5px 50px; font-family: Helvetica; font-size: 14px; color: #7F8C8D; line-height: 23px;">    
                                                                        ...
                                                                        <p style="margin: 0px 0px 10px 0px; line-height: 23px;">
                                                                            Congratulations on the first of what is sure to many years of a great business relationship. We are glad that to serve you with our services. Thank you for being a loyal customer for a year.</p>          
                                                                    </td>      
                                                                </tr>  
                                                            </tbody>
                                                        </table>
                                                                ...
                                                                <tr>
                                                                    <td align="left" class="mlContentContainer" style="padding: 15px 50px 5px 50px; font-family: Helvetica; font-size: 14px; color: #7F8C8D; line-height: 23px;">
                                                                        <p style="margin: 0px 0px 10px 0px; line-height: 23px;">
                                                                            ...
                                                                            As a token of appreciation, we are offering you {Discount_Amount_Or_Free_Gift}. Kindly use the coupon code {Coupon_Code} to avail the offer for the next purchase.
                                                                        </p>   
