...
{foreach from=$languages item=language}
	...
	<span class="margin-right translatable-field lang-{$language.id_lang|intval}">
	...
	{/if}
		...
		<div class="input-group">
			...
			class="form-control {if isset($input_class)}{$input_class|escape:'quotes':'UTF-8'} {/if} fixed-width-xl margin-right"
