...
{if isset($combinations) && is_array($combinations) && count($combinations)}
    ...
    <div class="selector_container">
        ...
        <div class="selector_item_bg-combinations">
        </div>
        <div class="selector_item">

            <a class="selector_item_close btn btn-danger btn-xs button float-right" title="{l s='Close' mod='masseditproduct'}" href="#">
                <i class="icon-close"></i>
            </a>

            {foreach from=$combinations key=id_pa item=combination}
                <div class="row_combination_{$id_pa|intval}">
