        ...
        <div class="block-property">
            {if is_array($variables.features) && count($variables.features)}
                <div class="form-group">
                    <div data-feature-btn class="btn btn-default margin-right">
                        <div class="column_feature">
                            <select class="custom-select" onclick="var btn = $(this).closest('[data-feature-btn]'); btn.find('[class^=column_feature_value_]').hide(); btn.find('.column_feature_value_'+$(this).val()).show();" name="variable_feature">
