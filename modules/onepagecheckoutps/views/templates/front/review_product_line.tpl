    ...
    <div class="col-md-{if $CONFIGS.OPC_SHOW_UNIT_PRICE}4{else}6{/if} col-xs-9 col-9 cart_description">
        ...
        {if !empty($product.customizations)}
            {foreach $product.customizations as $customization}
                <a href="#" data-toggle="modal" data-target="#product-customizations-modal-{$customization.id_customization|intval}">{l s='Product customization' d='Shop.Theme.Catalog'}</a>
