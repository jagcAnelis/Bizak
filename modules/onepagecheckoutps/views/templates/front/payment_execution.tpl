        ...
        <div id="onepagecheckoutps">
            ...
            <div id="opc_payment_compability">
                ...
                {foreach from=$payment_options item="option" key="id_option"}
                    {if $option->getCallToActionText() eq $payment_option_selected}
                        ...
                        <div id="payment-option-{$id_option|escape:'htmlall':'UTF-8'}-additional-information" class="js-additional-information definition-list additional-information">
