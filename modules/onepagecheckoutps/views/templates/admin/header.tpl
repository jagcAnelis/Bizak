...
<script type="text/javascript">
    {*removeIf(addons)*}
    var url_contact_presteam = '{$paramsBack.url_contact_presteam|escape:'htmlall':'UTF-8'}';
    var url_opinions_presteam = '{$paramsBack.url_opinions_presteam|escape:'htmlall':'UTF-8'}';
    {*endRemoveIf(addons)*}
