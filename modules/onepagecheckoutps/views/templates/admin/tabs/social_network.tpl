 ...
 * @category  Module
*}
{if 'checkoutBeta'|array_key_exists:$paramsBack.HELPER_FORM.tabs}
    <div class="tab-pane{if (isset($current_form) && $current_form eq 'checkoutBetaSocialNetwork')} active{/if}" id="tab-checkoutBetaSocialNetwork">
        <div class="row">
