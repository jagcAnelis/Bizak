...
class CartService extends AbstractStepCheckout
{
    ...
    public function setIdAddressDelivery($addressId, $setSameAddressToInvoice)
    {
        ...
        $isInvoiceAddressEnabled = $this->module->get('onepagecheckoutps.core.addresses')->isInvoiceAddressEnabled();
    ...
    public function setIdAddressInvoice($addressId)
    {
        ...
        $isDeliveryAddressEnabled = $this->module->get('onepagecheckoutps.core.addresses')->isDeliveryAddressEnabled();
