...
class HookDisplayHeaderService extends AbstractHook
{
    ...
    protected function executeRun()
    {
        ...
        $controller->registerStylesheet(
            sha1('https://fonts.googleapis.com/icon?family=Material+Icons'),
        ...
        $fileDatepicker = 'js/jquery/ui/i18n/jquery.ui.datepicker-' . $this->module->getContextProvider()->getLanguage()->iso_code . '.js';
        if (file_exists($fileDatepicker)) {
        ...
        $controller->registerJavascript(
            'module-onepagecheckoutps-form-validator',
            'modules/onepagecheckoutps/views/js/lib/form-validator/jquery.form-validator.min.js',
            array(
                'priority' => 50,
                'attribute' => 'defer',
            )
