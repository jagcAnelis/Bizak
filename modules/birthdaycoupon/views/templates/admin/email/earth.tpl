                            ...
                            <tbody>
                                <tr>
                                    <td align="center">
                                        ...
                                        <table align="center" border="0" bgcolor="#dc2929" class="mlContentTable" cellspacing="0" cellpadding="0" style="background: #dc2929; min-width: 640px; width: 640px;" width="640" id="ml-block-55149655">     
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <table width="640" class="mlContentTable" bgcolor="#dc2929" cellspacing="0" cellpadding="0" border="0" align="center" style="background: #dc2929; width: 640px;">  
                                                            <tbody>
                                                                <tr>
                                        ...
                                        <table align="center" border="0" bgcolor="#dc2929" class="mlContentTable" cellspacing="0" cellpadding="0" style="background: #dc2929; min-width: 640px; width: 640px;" width="640" id="ml-block-55149967">     
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <table width="640" class="mlContentTable" bgcolor="#dc2929" cellspacing="0" cellpadding="0" border="0" align="center" style="background: #dc2929; width: 640px;">         
                                                                ...
                                                                <tr>          
                                                                    <td align="left" class="mlContentContainer" style="padding: 15px 50px 5px 50px; font-family: Helvetica; font-size: 14px; color: #7F8C8D; line-height: 23px;">    
                                                                        ...
                                                                        <p style="margin: 0px 0px 10px 0px; line-height: 23px;">
                                                                            Thank you for being a loyal customer for a complete year. It’s a good time to treat yourself with something.</p>          
                                                                    </td>      
                                                                </tr>  
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <table width="640" class="mlContentTable" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" border="0" align="center" style="background: #FFFFFF; width: 640px;">      
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left" class="mlContentContainer" style="padding: 15px 50px 5px 50px; font-family: Helvetica; font-size: 14px; color: #7F8C8D; line-height: 23px;">
                                                                        <p style="margin: 0px 0px 10px 0px; line-height: 23px;">
                                                                         Enter the code {Coupon_Code} to get {Discount_Amount_Or_Free_Gift}
                                                                        </p>   
                                                                        <p style="margin: 0px 0px 10px 0px; line-height: 23px;">A great big thank you!<br/> <br/>
                                                                        Best regards<br />
                                        ...
                                        <table align="center" border="0" bgcolor="#00D0C0" class="mlContentTable" cellspacing="0" cellpadding="0" style="background: #dc2929; min-width: 640px; width: 640px;" width="640" id="ml-block-55148251">     
                                            <tbody>
                                                <tr>
                                                    <td> 
                                                        <table width="640" class="mlContentTable" bgcolor="#00D0C0" cellspacing="0" cellpadding="0" border="0" align="center" style="background: #dc2929; width: 640px;">      
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left" class="mlContentContainer" style="padding: 15px 50px 5px 50px; font-family: Helvetica; font-size: 14px; color: #7F8C8D; line-height: 23px;">                           
